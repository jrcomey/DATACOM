...
fn create_entity_blizzard_from_file() -> scenes_and_entities::Entity {
    ...
    // Body component
    // let wireframe_main_body = scenes_and_entities::WireframeObject::load_wireframe_from_obj("data/blizzard.obj", dc::green_vec());
    let body_component = scenes_and_entities::ModelComponent::load_from_json_file(&"data/object_loading/blizzard_initialize.json");
    blizzard_entity.add_model(body_component);
    ...
    let mut prop_FLT = scenes_and_entities::ModelComponent::load_from_json_file(&"data/object_loading/propellor_initialize.json");
