...
use winit::event::{Event, DeviceEvent, ElementState, WindowEvent, KeyEvent};
...
async fn start_program(scene: scenes_and_entities::Scene) {
    ...
    let mut state = scenes_and_entities::State::new(&window).await;
